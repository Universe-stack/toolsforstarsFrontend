            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                    <div>
                        ...
                        <p className="mt-5 text-gray-600">Or get started with <a href="#" title="" className="text-starspurpleLight transition-all duration-200 hover:underline ">self-service ads</a></p>
                    </div>
        ...
        <section className="py-[4rem] bg-gray-50 sm:py-16 lg:py-[4rem] w-full bg-[#FCF8F1]">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 w-[100%]">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="max-w-md mx-auto mt-4 text-[16px] leading-relaxed text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
                </div>
                ...
                <div className="mt-10">
                    <div className="flex items-center justify-center space-x-2.5">
                        ...
                        <button type="button" className="relative inline-flex flex-shrink-0 h-6 py-0.5 transition-colors duration-200 ease-in-out bg-transparent border-2 border-starsBlack rounded-full cursor-pointer w-12 focus:outline-none" role="switch" aria-checked>
                            <span aria-hidden="true" className="inline-block w-4 h-4 transition duration-200 ease-in-out translate-x-6 bg-starsBlack rounded-full shadow pointer-events-none"></span>
                        </button>
                ...
                <div className=" self-center grid grid-cols-1 gap-6 mx-auto sm:grid-cols-3 mt-14 md:gap-9 w-[90%]">
                        ...
                        <div className="p-6 md:py-8 md:px-9">
                            ...
                            <ul className="flex flex-col mt-8 space-y-4">
                                ...
                                <li className="inline-flex items-center space-x-2">
                                    ...
                                    <span className="text-[16px] mt-[0.3rem] font-medium text-gray-900"> Full Celebration Library </span>
                                </li>
                                ...
                                <li className="inline-flex items-center space-x-2">
                                    ...
                                    <span className="text-[16px] mt-[0.3rem] font-medium text-gray-900"> 120+ Coded Blocks </span>
                                </li>
                                ...
                                <li className="inline-flex items-center space-x-2">
                                    ...
                                    <strike className="text-[16px] mt-[0.3rem] font-medium text-gray-400"> Design Files Included </strike>
                                </li>
                                ...
                                <li className="inline-flex items-center space-x-2">
                                    ...
                                    <strike className="text-[16px] mt-[0.3rem] font-medium text-gray-400"> Premium Support </strike>
                                </li>
                            </ul>
                        </div>
                    </div>

                    <div className="overflow-hidden border-2 border-starsBlack bg-starspurpleLight text-starsWhite rounded-md">
                        <div className="p-6 md:py-8 md:px-9">
                            <h3 className="text-xl font-semibold text-black">Personal</h3>
                            <p className="mt-2.5 text-sm text-gray-600">All the basic features to boost your freelance career</p>
                            ...
                            <div className="flex items-end mt-5">
                                <div className="flex items-start">
                                    <span className="text-xl font-medium text-black"> $ </span>
                                    <p className="text-6xl font-medium tracking-tight">599</p>
                                </div>
                                <span className="ml-0.5 text-lg text-gray-600"> / month </span>
                            </div>
                            ...
                            <a
                                href="#"
                                title=""
                                className="inline-flex items-center justify-center w-full px-4 py-3 mt-6 font-semibold text-starsBlack transition-all duration-200 bg-starsWhite border-2 rounded-full  hover:bg-tarspurpleLight hover:text-white focus:text-white focus:bg-fuchsia-600"
                                role=""
                            >
                                Start 14 Days Free Trial
                            </a>
                    ...
                    <div className="overflow-hidden border-2 border-gray-200 rounded-md bg-starsWhite">
                        <div className="p-6 md:py-8 md:px-9">
                            <h3 className="text-xl font-semibold text-black">Personal</h3>
                            <p className="mt-2.5 text-sm text-gray-600">All the basic features to boost your freelance career</p>
