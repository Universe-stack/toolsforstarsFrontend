...
export function SaasPageClient({ initialSaasTools, initialAds, initialPagination, initialSortBy, initialCategory }) {
  ...
  useEffect(() => {
    setSaasTools(initialSaasTools);
    setAds(initialAds);
    setPagination(initialPagination);
  }, [initialSaasTools, initialAds, initialPagination]);
