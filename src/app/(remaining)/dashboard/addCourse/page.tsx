      ...
      <section className="py-3 sm:py-4 lg:py-12">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center flex flex-col">
            <h2 className="text-[12px] font-bold leading-tight text-starsBlack sm:text-[16px] lg:text-[16px] text-left mb-2">Resource name</h2>
            <input
              type="text"
              name="name"
              value={formData.name}
  ...
  return (
    <div className="bg-starsWhite py-10 w-full">
     { loading &&
      ...
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="mt-6 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Submit a <span className='text-starspurpleDark'>course</span></h2>
        <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600 text-starsGrey">
          Found a cool learning material you want everyone to know about? Or maybe you made one yourself and want the world to know about it? You&apos;re in the right place. So relax and follow the steps.
        </p>
      </div>
      {renderStage()}
    </div>
