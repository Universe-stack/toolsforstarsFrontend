...
const Page = () => {
    ...
    const { state, dispatch, handleSignIn } = useAuth();
    ...
    useEffect(() => {
      if (state.isLoading) {
        ...
        if (state.signInResult.message || state.user ) {
    ...
    }, [state.isLoading, state.signInResult,state.user,router])
  ...
  return (
    <section className="text-starsBlack relative">
        <ToastContainer className="absolute" />
        <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl">Sign in to Createcamp</h2>
                    ...
                    <form action="#" method="POST" className="mt-8" onSubmit={handleSubmit}>
                        <div className="space-y-5">
                            ...
                            <div>
                                <button type="submit" className="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-starsBlack text-starsWhite border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700">Log in</button>
                            </div>
                        </div>
                    </form>
